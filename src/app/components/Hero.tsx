    ...
    <div className="flex">
      <div>
        ...
        <motion.p
          ...
          className="mx-auto mt-6 max-w-lg text-lg tracking-tight text-slate-700"
        >
          Stuyvesant FTC Team 479 is a robotics team based in New York City that
          competes in the FIRST Tech Challenge.
        </motion.p>
        <div>
